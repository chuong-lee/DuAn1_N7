    ...
    <div class="menu">
        ...
        <div class="offcanvas-body pt-4">
            <ul class="nav flex-column side-menu">
                <!-- Sidebar - Brand--><a class="sidebar-brand d-flex align-items-center justify-content-center text-white fs-1" href="index.html">
                ...
                <li class="nav-item"><a class="nav-link collapsed hvr-forward py-3" href="#" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree"><i class="fas fa-fw fa-cog"></i><span>New</span></a>
                    <div class="collapse" id="collapseThree" aria-labelledby="headingThree" data-bs-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded-3 mx-2">
                            <h6 class="collapse-header">Custom Components:</h6>
                            <a class="collapse-item ms-2" href="profile.html">Profile</a>
                            <a class="collapse-item ms-2" href="">New Product</a>
                            <a class="collapse-item ms-2" href="">Update</a>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link hvr-forward py-3" href="index.html">
                        <i class="fa-solid fa-backward me-3"></i>Back To Website</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link hvr-forward py-3" href="login.html">
