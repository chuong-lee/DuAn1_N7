<div class="carousel slide" id="carouselExampleIndicator" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active"><img class="d-block w-100 carousel-img" src="../public/client/images/blog-1.png"></div>
      <div class="carousel-item"><img class="d-block w-100" src="../public/client/images/blog-2.png"></div>
      <div class="carousel-item"><img class="d-block w-100" src="../public/client/images/blog-3.png"></div>
    </div>
