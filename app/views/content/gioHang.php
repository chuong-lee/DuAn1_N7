            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping-cart-btns d-flex justify-content-between"><a class="primary-btn cart-btn">Tiếp Tục Mua Hàng</a>
                        <button class="cart-update primary-btn p-3 border-0 rounded-3">Cập Nhật Đơn Hàng</button>
                    </div>
                </div>
                    ...
                    <div class="shopping-checkout ">
                        ...
                        <ul>
                            <?php
                                ...
                                echo '
                                    <li>Tổng cộng: 
                                        <span class="cart-subtotal">'.$tongTien.'</span>
                                    </li>';
                            ?>
                        </ul>
                        <a class="shopping-btn" href="checkout.html">THANH TOÁN</a>
                    </div>
                </div>
            </div>
        </div>
